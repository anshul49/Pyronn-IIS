...
from pyronn.ct_reconstruction.helpers.filters.filters import ram_lak_3D, shepp_logan_3D
...
def example_cone_3d():
    ...
    geometry.init_from_parameters(volume_shape=volume_shape,volume_spacing=volume_spacing,
                                ...
                                trajectory=circular_trajectory_3d, source_isocenter_distance=sid, source_detector_distance=sdd)
