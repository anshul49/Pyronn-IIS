...
class List(ListParameter):
    """
    Immutable list/sequence parameter implementation enriched by metadata.
    ...
    value: Sequence = field(default_factory=list)
    ...
    @classmethod
    def from_dict(cls, input_dict: dict) -> List:
    ...
    def to_default(self) -> List:
        """Create new List with same metadata as current object, but with default value."""
        return self.with_value(self.default)

    def with_value(self, value: Sequence) -> List:
        """
