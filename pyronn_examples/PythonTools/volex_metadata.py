...
class ContinuableParameter:
    ...
    ct_parameter: CtParameter = field(default_factory=CtParameter)
...
class VolexMetaData:
    ...
    def _parse_xray_parameter(self, xml_element: Element):
        for child in xml_element:
            ...
            value = child.attrib['value'].replace(',', '.')  # XML uses German comma notation
        ...
        for child in xml_element:
            ...
            if property_name == 'ProjectionsPerZShift':
                ...
                for sub_child in child:
                    ...
                    value = sub_child.attrib['value'].replace(',', '.')  # XML uses German comma notation
